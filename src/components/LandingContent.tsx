...
export const LandingContent: React.FC = () => {
  ...
  const problemItems: ProblemItem[] = [
    ...
    { image: problemImg3, title: 'No real accountability', stats: [{ value: 'Trusted', label: 'CIRCLE' }, { value: 'No', label: 'BROADCAST' }, { value: 'Real', label: 'SUPPORT' }], problemDesc: 'Going it alone is hard. You need someone in your corner—without broadcasting to the world.', solution: 'Family connection. Private accountability partners. Invite trusted people—no social feed.', basicClosing: 'Real support, Real results.' },
